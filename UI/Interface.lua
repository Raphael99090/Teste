...
function Interface:Load(Hub, Config, State)
    ...
    TabCombat:CriarToggle("Health Bar (Vida)", false, function(v) if Hub.Features.ESP then Hub.Features.ESP.Settings.HealthBar = v end end)
    ...
    -- [ EXTRAS ]
    TabExtra:CriarToggle("Auto Equipar Arma", false, function(v) Config.AutoEquip = v end)
